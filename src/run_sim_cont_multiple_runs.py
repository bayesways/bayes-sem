...
parser.add_argument(
    "-sim_case",
    "--sim_case",
    help="simulation case number", type=int, default=0
    )
parser.add_argument(
    "-num_warmup",
    "--num_warmup",
...
parser.add_argument("-nsim", "--nsim_sim",
                    help="number of simulations", type=int, default=100)
...
if args.existing_directory is None:
    ...
    log_dir = "./log/"+nowstr+"%s_m%s_s%s_%s/" % (args.task_handle,
                                              args.stan_model, args.sim_case, args.ppp_cv)
