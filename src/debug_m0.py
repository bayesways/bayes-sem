...
from codebase.data_db import gen_data0
import argparse
...
parser.add_argument("-rho","--rho_param", help="off diag correlation of Theta", type=float, default=0.4)
...
if args.load_model == False:
    ...
    # with open('./codebase/stan_code/discr/CFA/logit/test/model0.stan', 'r') as file:
    with open('./codebase/stan_code/discr/CFA/logit/test/model0a.stan', 'r') as file:
    # with open('./codebase/stan_code/discr/CFA/logit/test/model0b.stan', 'r') as file:
        model_code = file.read()
    param_names = ['L', 'yy', 'R', 'alpha']
